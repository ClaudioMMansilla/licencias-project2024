...
public class EmisionHojaRuta_View extends JFrame {
...
//	public List<HojaRuta> listItems;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					EmisionHojaRuta_View frame = new EmisionHojaRuta_View(isVisible);
	 ...
	 * Create the frame.
	 */
	public EmisionHojaRuta_View(boolean isVisible) {
...
//					}
		...
		jbCargar.setBounds(118, 11, 90, 25);
...
//		new RestrictedTextField(txtNroPedido);
//	    TextPrompt placeholder = new TextPrompt("Ingrese nro", txtNroPedido);
