...
public class UserLogin_PanDulce extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
                try {
                	UserLogin_PanDulce frame = new UserLogin_PanDulce();
...
//    					EnvasadoInputBudines frame = new EnvasadoInputBudines(userName);
//    					frame.setVisible(true);
