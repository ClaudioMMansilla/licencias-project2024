...
public class EnvasadoInputPD7meses extends JFrame {
...
//	String tablaInput = "desarrollo.env_input_budines";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					EnvasadoInputPD7meses frame = new EnvasadoInputPD7meses(userSes);
	 ...
	 * @return
	 */
	public EnvasadoInputPD7meses(String userSes) {
