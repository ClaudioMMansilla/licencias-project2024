...
public class EnvasadoInputPD12meses extends JFrame {
...
//	String tablaInput = "desarrollo.env_input_budines";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					EnvasadoInputPD12meses frame = new EnvasadoInputPD12meses(userSes);
	 ...
	 * @return
	 */
	public EnvasadoInputPD12meses(String userSes) {
