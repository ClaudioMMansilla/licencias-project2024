...
public class envasadoFR1 extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					envasadoFR1 frame = new envasadoFR1();
	...
	public envasadoFR1() {
		...
		JButton jbt1_informe = new JButton("Informe de Envasado");
		...
		JButton jbt2_registro = new JButton("Registros de Ingresos");
		...
		jbt2_registro.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				envasadoFR2 frame02 = new envasadoFR2();
		...
		JButton jbt3_informe = new JButton("Informe de Envasado");
		...
		JButton jbt4_registro = new JButton("Registros de Ingresos");
		...
		jbt4_registro.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				envasadoFR4 frame04 = new envasadoFR4();
