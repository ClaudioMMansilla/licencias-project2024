...
public class EnvasadoInputPD8meses extends JFrame {
...
//	String tablaProductos = "pruebas_2022.productos";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					EnvasadoInputPD8meses frame = new EnvasadoInputPD8meses();
