...
public class EnvasadoInputPdulces7meses extends JFrame {
...
//	String tablaProductos = "pruebas_2022.productos";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					EnvasadoInputPdulces7meses frame = new EnvasadoInputPdulces7meses();
	 ...
	 * Create the frame.
	 */
	public EnvasadoInputPdulces7meses() {
				...
				int cantidad = Integer.parseInt(stringCantidad);
	   			...
	   			else
	   			{
					...
					String sql = "INSERT into "+tablaInput+" "
							...
							+ "values ('"+fechaIngreso+"', '"+pcUsuario+"', '"+id+"', '"+domicilio+"', '"+descripProducto+"', '"+diaDelAnio+"', '"+formattedLocalDate+"', '"+cantidad+"', '"+flagDisponible+"', '"+flagAjuste+"')";
	...
	public  void Reporte03() throws JRException {
    	...
    	parametros.put("operador", stringOperador);
