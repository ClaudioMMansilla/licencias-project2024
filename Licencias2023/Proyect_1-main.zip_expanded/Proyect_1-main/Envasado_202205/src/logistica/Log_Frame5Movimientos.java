...
public class Log_Frame5Movimientos {
	...
	public void consultarBoxes() {
		...
		columnModel.getColumn(5).setPreferredWidth(70);  //Movim
		columnModel.getColumn(6).setPreferredWidth(90); //Usuario
		columnModel.getColumn(7).setPreferredWidth(80);  //Id Cliente
		columnModel.getColumn(8).setPreferredWidth(280); //Razon Social
...
//	String tablaMovim = "pruebas_2022.reg_movim_productos";
	...
	private final String pstConsulta1 = "SELECT fecha, hora, idProducto, producto, movimCantidad, movimTipo, movimUsuario, idCliente, razonSocial "
			+ "FROM "+tablaMovim+" WHERE movimTipo=? AND fecha =?"; // FINAL para que sea constante y no pueda ser modificada

	private String pstConsulta2 = "SELECT fecha, hora, idProducto, producto, movimCantidad, movimTipo, movimUsuario, idCliente, razonSocial "
