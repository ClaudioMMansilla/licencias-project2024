...
public class Log_Frame6OutputManual extends javax.swing.JFrame {

    public Log_Frame6OutputManual() {
        initComponents();
   			...
   			while(rs.next())
   			{
		    	...
		    	System.out.println("bucle while ejecutado");
   				...
   				if(tfield_id != null && tfield_cantidad != null &&texto_cantidad != null && cantidad_usuario > 0) {
   					String sql = "update "+tablaProductos+" set stock= '"+stock_suma+"', movimCantidad='"+cantidad_usuario+"', movimTipo='Ingreso', movimUsuario='"+identidad+"' where idProducto='"+id+"'";
   					int rowsAffected = stm.executeUpdate(sql);
   					System.out.println("Rows affected: " + rowsAffected);
   					System.out.println("SQL Ejecutado");
   					jLabelMsjGuardar.setText("Tu �ltimo ingreso realizado fue " + " ID:   " + id +"   |   "+" Cantidad:   "+ cantidad_usuario);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
			public void run() {
                new Log_Frame6OutputManual().setVisible(true);
            }
        });
    }
