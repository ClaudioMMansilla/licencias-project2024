...
public class UserLogin_EnvasadoUnificado extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
                try {
                	UserLogin_EnvasadoUnificado frame = new UserLogin_EnvasadoUnificado();
     ...
     * Create the frame.
     */
    public UserLogin_EnvasadoUnificado() {
...
//                        "root", "root");
                    ...
                    if (rs.next()) {
                        dispose();
                        user = rs.getString(3);
                    	UserHome nextMVC = new UserHome(user);
                    	nextMVC.setVisible(true);
