...
//    }
    ...
    public UserHome(String userSes) {
        ...
        JButton btnNewButton = new JButton("Abrir Aplicaci�n");
        btnNewButton.setForeground(new Color(0, 0, 0));
        btnNewButton.setBackground(UIManager.getColor("Button.disabledForeground"));
        btnNewButton.setFont(new Font("Tahoma", Font.PLAIN, 20));
        btnNewButton.setBounds(26, 42, 290, 50);
        contentPane.add(btnNewButton);
        btnNewButton.addActionListener(new ActionListener() {
            @Override
			public void actionPerformed(ActionEvent e) {
				EnvasadoInputBudines frame = new EnvasadoInputBudines(userSes);
				frame.setTitle("Vencimiento: 6 meses -- Operador: "+userSes);
				frame.setVisible(true);
            }
        });


        JButton btnNewButton2 = new JButton("Modificar pallet");
        ...
        btnNewButton2.setBounds(26, 103, 290, 50);
        contentPane.add(btnNewButton2);
        btnNewButton2.addActionListener(new ActionListener() {
            @Override
			public void actionPerformed(ActionEvent e) {
				Env_UpdateInputBud frame = new Env_UpdateInputBud(userSes);
				frame.setVisible(true);
            }
        });
        ...
        button_1.setBounds(26, 204, 290, 50);
        ...
        button_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
                ...
                if (a == JOptionPane.YES_OPTION) {
                    dispose();
//                    UserLogin_Budines obj = new UserLogin_Budines();
